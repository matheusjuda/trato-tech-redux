...
export default function Item(props) {
  ...
  const estaNoCarrinho = useSelector(state => state.carrinho.some(itemNoCarrinho => itemNoCarrinho.id === id)); //se esta no carrinho
      ...
      <div className={styles['item-descricao']}>
        ...
        <div className={styles['item-info']}>
          ...
          <div className={styles['item-acoes']}>
            ...
            {carrinho
              ? (
                <div className={styles.quantidade}> {/* Se o item estiver na page de carrinho rederiza: */}
                  Quantidade:
              ...
              : (<FaCartPlus //Se estiver na page de produto renderiza:
                {...iconeProps}
